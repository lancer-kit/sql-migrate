...
// sources:
// test-migrations/0001_00_initial.sql (218B)
// test-migrations/0002_00_record.sql (100B)
...
var _testMigrations0002_00_recordSql = []byte("")

func testMigrations0002_00_recordSqlBytes() ([]byte, error) {
	return bindataRead(
		_testMigrations0002_00_recordSql,
		"test-migrations/0002_00_record.sql",
	)
}

func testMigrations0002_00_recordSql() (*asset, error) {
	bytes, err := testMigrations0002_00_recordSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "test-migrations/0002_00_record.sql", size: 100, mode: os.FileMode(0644), modTime: time.Unix(1587628088, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"test-migrations/0001_00_initial.sql": testMigrations0001_00_initialSql,
	"test-migrations/0002_00_record.sql":  testMigrations0002_00_recordSql,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"test-migrations": &bintree{nil, map[string]*bintree{
		"0001_00_initial.sql": &bintree{testMigrations0001_00_initialSql, map[string]*bintree{}},
		"0002_00_record.sql":  &bintree{testMigrations0002_00_recordSql, map[string]*bintree{}},
	}},
}}
